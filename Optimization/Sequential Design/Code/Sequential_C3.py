...
def fun_Power3(input):
    ...
    max_no_borr = fun_cutoffValueFinder(0, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[1]
    max_borr = fun_cutoffValueFinder(0, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[2]
    ...
    if typeIerror_no_borr > max_no_borr:
        ...
        def root_function_borr(cutoffValue_borr):
            return fun_cutoffValueFinder(cutoffValue_borr, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[2] - (
                        alpha - max_no_borr)
        ...
        def root_function_no_borr(cutoffValue_no_borr):
            return fun_cutoffValueFinder(cutoffValue_no_borr, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[1] - (
                        alpha - max_borr)
        ...
        def root_function_no_borr(cutoffValue_no_borr):
            return fun_cutoffValueFinder(cutoffValue_no_borr, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[
                1] - typeIerror_no_borr

        sol_no_borr = root_scalar(root_function_no_borr, bracket=[0, 10], method='brenth', xtol=1e-12, maxiter=10000)
        cutoffValue_no_borr = sol_no_borr.root

        def root_function_borr(cutoffValue_borr):
            return fun_cutoffValueFinder(cutoffValue_borr, 0, 0, 0, W2_var, x2_var_stage1, W1_var, corr_w2x2, theta)[
                2] - typeIerror_borr
